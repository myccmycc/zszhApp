...
internal class _Zszh_jiancaiEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("resPath", "id", "resourcePath", "ImgThumbnail", "className", "classArgument", "objectName");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("id");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("resPath", "id", "resourcePath", "ImgThumbnail", "className", "classArgument", "objectName");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("resPath", "id", "resourcePath", "ImgThumbnail", "className", "classArgument", "objectName");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("resPath", "id", "resourcePath", "ImgThumbnail", "className", "classArgument", "objectName");
    ...
    public function _Zszh_jiancaiEntityMetadata(value : _Super_Zszh_jiancai)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["resPath"] = new Array();
        ...
        model_internal::propertyTypeMap["resPath"] = "String";
    ...
    [Bindable(event="propertyChange")]
    public function get isResPathAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get resPathStyle():com.adobe.fiber.styles.Style
    {
